...
/// <summary>
/// Headless counterpart of the GUI's HybridFileProvider. Local-archive only:
/// the manifest (on-demand) registration path is intentionally absent so this project
/// carries no EpicManifestParser dependency and no static UEParse references.
/// </summary>
public class HeadlessFileProvider : AbstractVfsFileProvider
{
    ...
    public HeadlessFileProvider(string directory, List<DirectoryInfo>? extraDirectories = null, VersionContainer? version = null)
        : base(version, StringComparer.OrdinalIgnoreCase)
    {
